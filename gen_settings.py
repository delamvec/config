...
v_serverUserPass='mt2 TyPicoToJeExtrem'							#user&pwd for sql connections
v_serverData=f"{v_serverHostname} {v_serverUserPass}"	#host, user and pwd for db sql connections

v_bindHostname='10.0.2.15' #ip adresa stroje na kterem bezi vbox
v_p2pHostname='127.0.0.1'  # IP pro lokální P2P komunikaci mezi cores
v_proxyHostname='10.56.251.77' #your IP
...
M2PORTS = {
	"srv1-db":(30000), #db port
	"srv1-auth1":(30001,30002), #port,p2p_port
	# CH1 - 3 cores
	"srv1-ch1-core1":(30003,30004),
	"srv1-ch1-core2":(30005,30006),
	"srv1-ch1-core3":(30007,30008),
	# CH2 - 3 cores
	"srv1-ch2-core1":(30009,30010),
	"srv1-ch2-core2":(30011,30012),
	"srv1-ch2-core3":(30013,30014),
	# CH3 - 3 cores
	"srv1-ch3-core1":(30015,30016),
	"srv1-ch3-core2":(30017,30018),
	"srv1-ch3-core3":(30019,30020),
	# CH4 - 3 cores
	"srv1-ch4-core1":(30021,30022),
	"srv1-ch4-core2":(30023,30024),
	"srv1-ch4-core3":(30025,30026),
	# CH99 - 5 cores
	"srv1-ch99-core1":(30027,30028),
	"srv1-ch99-core2":(30029,30030),
	"srv1-ch99-core3":(30031,30032),
	"srv1-ch99-core4":(30033,30034),
	"srv1-ch99-core5":(30035,30036),
}
...
M2CONFIG = {
	...
	# Speciální konfigurace pro OX event core (ch99-core5)
	"core_ox": {
		M2TYPE.AUTH: (
			("AUTH_SERVER: {}", "master"),
			("PLAYER_SQL: {} {} {}", (v_serverData, M2SD["account"], v_mysqlport)),
		...
		"general": (
			("VIEW_RANGE: {}", 10000),
			("PASSES_PER_SEC: {}", 25),
			("SAVE_EVENT_SECOND_CYCLE: {}", 600),  # Optimalizace pro OX - save každých 10 minut
			("PING_EVENT_SECOND_CYCLE: {}", 180),
			#
			("BIND_IP: {}", v_bindHostname),
			("PROXY_IP: {}", v_proxyHostname),
			("DB_ADDR: {}", v_dbHostname),
			("COMMON_SQL: {} {} {}", (v_serverData, M2SD["common"], v_mysqlport)),
			("LOG_SQL: {} {} {}", (v_serverData, M2SD["log"], v_mysqlport)),
			("TEST_SERVER: {:d}", True),
...
COMMONCHAN=(
	...
	},
	{
		...
		"type": M2TYPE.CORE,
		"config": M2CONFIG["core"],
		"maps": "3 23 43 4 24 44 5 25 45 108 109 112 301 302 303 304",  # Leveling + Endgame
	},
	{
		"name": "core3",
		"type": M2TYPE.CORE,
		"config": M2CONFIG["core"],
		"maps": "61 62 63 64 65 66 67 68 69 70 71 72 73 104 193 206 208 207 216 217 351",  # Dungeony + PvP
	},
)

# CH99: 5 cores pro eventy
CHAN99=(
	{
		"name": "core1",
		"type": M2TYPE.CORE,
		"config": M2CONFIG["core"],
		"maps": "81 103 105",  # Spawn/Lobby mapy
	},
	{
		"name": "core2",
		"type": M2TYPE.CORE,
		"config": M2CONFIG["core"],
		"maps": "113",  # OX EVENT - izolovaný core pro 300+ hráčů
	},
	{
		"name": "core3",
		"type": M2TYPE.CORE,
		"config": M2CONFIG["core"],
		"maps": "114 118 119 120",  # Velké PvP eventy
	},
	{
		"name": "core4",
		"type": M2TYPE.CORE,
		"config": M2CONFIG["core"],
		"maps": "121 122 123 124 125 126 127 128",  # Team eventy, Arény
	},
	{
		"name": "core5",
		"type": M2TYPE.CORE,
		"config": M2CONFIG["core_ox"],  # OX optimalizace - SAVE_EVENT_SECOND_CYCLE: 600
		"maps": "110 111 181 182 183 200",  # Boss raids, Speciální eventy
	},
)
